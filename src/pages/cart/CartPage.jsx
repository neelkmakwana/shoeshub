                ...
                <div className="mx-auto max-w-2xl py-8 lg:max-w-7xl">
                    ...
                    <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                                ...
                                {cartItems.length > 0 ?
                                    ...
                                    <>
                                        {cartItems.map((item, index) => {
                                            const { id, title, price, productImageUrl, productSize,color ,quantity, category } = item
                                            return (
                                                            ...
                                                            <div className="pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                                                <div>
                                                                    ...
                                                                    <div className="mt-1 flex text-sm">
                                                                        <p className="text-sm text-gray-800">Category : {category.charAt(0).toUpperCase() + category.slice(1).toLowerCase()}</p>
                                                                    </div>
                                                    ...
                                                    <div className="mb-2 flex">
                                                        ...
                                                        <div className="ml-6 flex text-sm">
                                                            <button onClick={() => deleteCart(item)} type="button" className="flex items-center space-x-1 px-2 py-1 pl-0">
                                                                <Trash size={12} className="text-indigo-600" />
                                                                <span className="text-xs font-medium text-indigo-600">Remove</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="text-center mt-20">
                                      ...
                                      <h1 className="text-black text-xl">No Footwear Found in Your Cart</h1>
                                    </div>
                                  </div>
                        ...
                        >
                            <h2
                                id="summary-heading"
                                className=" border-b border-indigo-200 px-4 py-3 text-lg font-medium text-gray-900 sm:p-4"
                            >
                                Price Details
                            </h2>
                            <div>
                                <dl className=" space-y-1 px-2 py-4">
                                    ...
                                    <div className="flex items-center justify-between border-y border-dashed py-4" style={{ borderColor: '#3949AB' }}>
