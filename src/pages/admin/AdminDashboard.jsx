                ...
                <div className="mid mb-5">
                    ...
                    <div className=" bg-cyan-100 py-5 rounded-xl border border-indigo-600">
                        ...
                        <div className="flex justify-center">
                            <img src="https://cdn-icons-png.flaticon.com/128/4859/4859066.png" alt="" />
                        </div>
                        {/* text  */}
                        <div className="">
                            {/* Name */}
                ...
                <div className="">
                    ...
                    <TabList className="flex flex-wrap -m-4 text-center justify-center">
                        ...
                        <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                            <div className=" border bg-cyan-100 hover:bg-cyan-200 border-indigo-600 px-4 py-3 rounded-xl" >
                                ...
                                <h2 className="title-font font-medium text-3xl text-indigo-600 fonts1" >{getAllProduct.length}</h2>
                                <p className=" text-indigo-600  font-bold" >Total Footwear</p>
                            </div>
                        </Tab>
                        ...
                        <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                            <div className="border bg-cyan-100 hover:bg-cyan-200 border-indigo-600 px-4 py-3 rounded-xl" >
                                ...
                                <h2 className="title-font font-medium text-3xl text-indigo-600 fonts1" >{getAllOrder.length}</h2>
                        ...
                        <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                            <div className="border bg-cyan-100 hover:bg-cyan-200 border-indigo-600 px-4 py-3 rounded-xl" >
                                ...
                                <h2 className="title-font font-medium text-3xl text-indigo-600 fonts1" >{getAllUser.length}</h2>
                                <p className=" text-indigo-600  font-bold" >Total User</p>
                            </div>
                        </Tab>
                    </TabList>
